...
namespace Media_Gate.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserName,Email,Password,Phone,Country")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserName,Email,Password,Phone,Country")] User user)
        {
            if (ModelState.IsValid)
            {
